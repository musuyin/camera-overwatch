...
| 用户动作 | 识别维度 | 游戏指令 |
|----------|----------|----------|
| 右手向前伸出 | 右手伸出 | 鼠标左键点击（普攻） |
| 右手抬至上部区域 | 右手区域：上 | Shift 按住（立盾） |
| 右手回到中/下区域 | 右手区域：中/下 | Shift 释放 |
| 右手压至下部区域 | 右手区域：下 | E（丢漩涡） |
...
| 用户动作 | 识别维度 | 游戏指令 |
|----------|----------|----------|
| 右手向前伸出 | 右手伸出 | 鼠标左键点击（右拳） |
| 左手向前伸出 | 左手伸出 | 鼠标右键点击（左拳） |
| 双手同时向前伸出 | 双手同时伸出 | Shift 按住（格挡） |
| 双手同时收回 | 双手同时收回 | Shift 释放 |
| 双手手腕交叉 | 双手交叉 | 退出天罚形态 |
